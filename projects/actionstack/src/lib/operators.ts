import { CustomObservable, CustomSubject, IObservable, OperatorFunction } from "./observable";
...
export function concatMap<T>(projector: (value: T) => Promise<T>) {
  return (source: IObservable<T>) => new CustomObservable<T>(subscriber => {
 ...
 */
export function concat<T>(...sources: IObservable<T>[]): IObservable<T> {
 ...
 */
export function merge<T>(...sources: IObservable<T>[]): IObservable<T> {
  return new CustomObservable<T>(subscriber => {
 ...
 */
export function waitFor<T>(obs: IObservable<T>, predicate: (value: T) => boolean): Promise<T> {
