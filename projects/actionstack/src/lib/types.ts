...
import { IObservable, isObservable } from "./observable";
 ...
 */
export type SideEffect = (action: IObservable<Action<any>>, state: IObservable<any>, dependencies: Record<string, any>) => IObservable<Action<any>>;
